...
- 前提・基礎・中核・応用のナレッジグラフに基づく学習計画
- 解答記録と復習タイミングの管理
- 公式PDFを参照する専用解答画面、タイマー、AIチャット
- 学習分野・理解度・復習時期に応じたおすすめ演習
- 自信度、ヒント・解答参照、つまずいた分野を残せる学習記録
...
- 外部公開PDF: 公式公開元へのリンクと埋め込み可否だけをD1で管理
...
学習順序の生成には、MITライセンスの
[`KTaisei/KnowledgeGraph`](https://github.com/KTaisei/KnowledgeGraph) を固定コミットで利用します。
Python/Ollamaによる生成は運営側のオフライン工程で行い、レビュー済みグラフだけをD1へ取り込みます。
取得・検証・インポート方法は [KnowledgeGraph integration](docs/knowledge-graph-integration.md) を参照してください。
